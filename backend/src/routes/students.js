...
router.get('/lessons', requireAuth, requireRole('student'), asyncHandler(async (req, res) => {
...
router.get('/payments', requireAuth, requireRole('student'), asyncHandler(async (req, res) => {
  const result = await pool.query(
