...
router.post('/', requireAuth, requireRole('admin', 'supervisor'), asyncHandler(async (req, res) => {
...
router.patch('/:id', requireAuth, requireRole('admin', 'supervisor'), asyncHandler(async (req, res) => {
  const { title, description, price, is_free, thumbnail_url } = req.body;
  const result = await pool.query(
...
router.delete('/:id', requireAuth, requireRole('admin', 'supervisor'), asyncHandler(async (req, res) => {
...
router.post('/:id/lessons', requireAuth, requireRole('admin', 'supervisor'), asyncHandler(async (req, res) => {
...
router.delete('/:courseId/lessons/:lessonId', requireAuth, requireRole('admin', 'supervisor'), asyncHandler(async (req, res) => {
