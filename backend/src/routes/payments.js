...
router.get('/', requireAuth, requireRole('admin', 'supervisor', 'teacher'), asyncHandler(async (req, res) => {
  let result;
...
router.post('/generate', requireAuth, requireRole('admin', 'supervisor'), asyncHandler(async (req, res) => {
...
router.patch('/:id/mark-paid', requireAuth, requireRole('admin', 'supervisor'), asyncHandler(async (req, res) => {
  const result = await pool.query(
