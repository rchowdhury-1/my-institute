...
router.post('/', requireRole('teacher', 'admin', 'supervisor'), asyncHandler(async (req, res) => {
...
router.get('/:id/submissions', requireRole('teacher', 'admin'), asyncHandler(async (req, res) => {
...
router.patch('/:id/grade', requireRole('teacher', 'admin', 'supervisor'), asyncHandler(async (req, res) => {
