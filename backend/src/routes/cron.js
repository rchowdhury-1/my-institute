...
router.post('/generate-sessions', requireAuth, requireRole('admin', 'supervisor'), asyncHandler(async (req, res) => {
...
router.post('/regenerate-all', requireAuth, requireRole('admin', 'supervisor'), asyncHandler(async (req, res) => {
